...
async def create_botlog(client):
    ...
    desc = "Group Log untuk NandaPedia-PyBot.\n\nHARAP JANGAN KELUAR DARI GROUP INI.\n\n⚡ Powered By ~ @nandapedia ⚡"
    try:
        ...
        LOGGER("NandaPedia").warning(
            "var BOTLOG_CHATID kamu belum di isi. Buatlah grup telegram dan masukan bot @nandapediabot lalu ketik /id Masukan id grup nya di var BOTLOG_CHATID"
        )
